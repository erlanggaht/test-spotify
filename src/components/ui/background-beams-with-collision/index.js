...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    (<div
      ref={parentRef}
      className={cn(
        "fixed z-[-9999999999px]  bottom-0 left-0 h-screen md:h-[40rem] bg-gradient-to-b from-white to-neutral-100 dark:from-neutral-950 dark:to-neutral-800  flex items-center w-full justify-center overflow-hidden",
