...
export function ExpandableCard({ name, type, image, handlePlay, genres }) {
  const cards = [
    {
      description: type || "Erlangga ganteng",
      title: name || "name",
      src: image || "https://assets.aceternity.com/demos/lana-del-rey.jpeg",
      ctaText: "Play",
              ...
              {genres?.map((genre, index) => {
                return (
                  <Badge
                    ...
                    variant="outline"
                    className={
                      "hover:bg-sky-500 cursor-pointer hover:text-white"
                    }
                  >
                    {genre}
                  </Badge>
